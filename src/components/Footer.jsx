          ...
          <div className="lg:col-span-2">
            ...
            >
              ...
              <p className="text-gray-400 mb-6 max-w-md">
                Making classrooms accessible for deaf students through our web platform and Chrome extension with 3D avatar technology.
              </p>
        ...
        >
          <div className="max-w-md">
            ...
            <p className="text-gray-400 text-sm mb-4">
              Get the latest news and updates about SignBridge and accessibility in education.
            </p>
            <div className="flex">
              <input
                type="email"
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-gray-400 text-sm">
              © {currentYear} SignBridge. All rights reserved.
            </div>
